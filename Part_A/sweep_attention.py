...
def sweep_run():
    ...
    dec = Decoder(len(TGT_VOCAB), cfg.emb_dim, cfg.hid_dim, cfg.dec_layers, cfg.cell, cfg.dropout, use_attn=True)
    ...
    for epoch in range(1,11):
        ...
        if vl_l < best_vl:
            ...
            wandb.save('models/best_attention_model2.pt')

if __name__=='__main__':
    sweep_id=wandb.sweep(sweep_cfg, project='assignment3_sweep_attention')
